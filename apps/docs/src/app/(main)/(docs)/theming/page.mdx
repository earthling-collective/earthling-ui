export const metadata = {"title":"Theming","description":"Customize Earthling UI with CSS variables, built-in themes, and your own custom themes."};
...
If your bundler imports stylesheets from JavaScript instead, the direct file paths work in any bundler:
